...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Label6 = New Label()
        Label9 = New Label()
        cmbIncentive = New Guna.UI2.WinForms.Guna2ComboBox()
        cmbSize = New Guna.UI2.WinForms.Guna2ComboBox()
        cmbTrade = New Guna.UI2.WinForms.Guna2ComboBox()
        btnFill = New Guna.UI2.WinForms.Guna2Button()
        ...
        dtpDOE = New Guna.UI2.WinForms.Guna2DateTimePicker()
        Label4 = New Label()
        GroupBox1 = New GroupBox()
        cmbSearch = New Guna.UI2.WinForms.Guna2ComboBox()
        txtSearch = New Guna.UI2.WinForms.Guna2TextBox()
        Label11 = New Label()
        txtCount = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        dtpNotification = New DateTimePicker()
        dtpFFBDate = New DateTimePicker()
        dtpDOB2 = New DateTimePicker()
        dtpDOE2 = New DateTimePicker()
        dtpDOI = New DateTimePicker()
        txtDetails = New Guna.UI2.WinForms.Guna2TextBox()
        btnResetForm = New Guna.UI2.WinForms.Guna2Button()
        btnCreateDocs = New Guna.UI2.WinForms.Guna2Button()
        txtLocation = New Guna.UI2.WinForms.Guna2TextBox()
        btnOpenDirectory = New Guna.UI2.WinForms.Guna2Button()
        btnStatement = New Guna.UI2.WinForms.Guna2Button()
        ...
        btnUpdateDB = New Guna.UI2.WinForms.Guna2Button()
        Label10 = New Label()
        lblOBS = New Label()
        ...
        lblAppealDate = New Guna.UI2.WinForms.Guna2HtmlLabel()
        ...
        ' TabPage3
        ' 
        TabPage3.BackColor = Color.FromArgb(CByte(142), CByte(199), CByte(210))
        TabPage3.Controls.Add(GroupBox2)
        TabPage3.Controls.Add(GroupBox1)
        TabPage3.Controls.Add(Label4)
        TabPage3.Controls.Add(dtpDOE)
        TabPage3.Controls.Add(dtpDOB)
        TabPage3.Controls.Add(txtEMail)
        TabPage3.Controls.Add(txtFName)
        ...
        ' GroupBox3
        ' 
        GroupBox3.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        GroupBox3.Controls.Add(btnFill)
        GroupBox3.Controls.Add(cmbTrade)
        GroupBox3.Controls.Add(cmbSize)
        GroupBox3.Controls.Add(cmbIncentive)
        GroupBox3.Controls.Add(Label9)
        GroupBox3.Controls.Add(Label6)
        GroupBox3.Controls.Add(Label5)
        GroupBox3.Controls.Add(txtLName)
        ...
        GroupBox3.Location = New Point(5, 3)
        ...
        Label2.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        ...
        Label1.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        ...
        Label3.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        ...
        Label8.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        Label8.Location = New Point(50, 349)
        Label8.Name = "Label8"
        ...
        Label7.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        Label7.Location = New Point(39, 306)
        Label7.Name = "Label7"
        ...
        txtID.CustomizableEdges = CustomizableEdges39
        txtID.DefaultText = ""
        ...
        txtID.SelectedText = ""
        txtID.ShadowDecoration.CustomizableEdges = CustomizableEdges40
        ...
        txtLName.CustomizableEdges = CustomizableEdges37
        ...
        txtLName.Margin = New Padding(4, 4, 4, 4)
        txtLName.Name = "txtLName"
        txtLName.PasswordChar = ChrW(0)
        txtLName.PlaceholderText = ""
        txtLName.SelectedText = ""
        txtLName.ShadowDecoration.CustomizableEdges = CustomizableEdges38
        ...
        Label5.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        ...
        Label6.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        Label6.Location = New Point(47, 181)
        Label6.Name = "Label6"
        ...
        Label9.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        Label9.Location = New Point(10, 394)
        Label9.Name = "Label9"
        ...
        ' cmbIncentive
        ' 
        cmbIncentive.AutoRoundedCorners = True
        ...
        cmbIncentive.CustomizableEdges = CustomizableEdges35
        ...
        cmbIncentive.ShadowDecoration.CustomizableEdges = CustomizableEdges36
        cmbIncentive.Size = New Size(370, 36)
        cmbIncentive.TabIndex = 9
        ' 
        ' cmbSize
        ' 
        cmbSize.AutoRoundedCorners = True
        ...
        cmbSize.CustomizableEdges = CustomizableEdges33
        ...
        cmbSize.ShadowDecoration.CustomizableEdges = CustomizableEdges34
        ...
        cmbTrade.CustomizableEdges = CustomizableEdges31
        ...
        cmbTrade.ShadowDecoration.CustomizableEdges = CustomizableEdges32
        ...
        btnFill.CustomizableEdges = CustomizableEdges29
        ...
        btnFill.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnFill.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        btnFill.Font = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        btnFill.ForeColor = Color.White
        btnFill.Location = New Point(359, 196)
        btnFill.Name = "btnFill"
        btnFill.ShadowDecoration.CustomizableEdges = CustomizableEdges30
        ...
        dgvRoster.GridColor = Color.FromArgb(CByte(50), CByte(56), CByte(62))
        dgvRoster.Location = New Point(0, 466)
        dgvRoster.Name = "dgvRoster"
        dgvRoster.ReadOnly = True
        dgvRoster.RowHeadersVisible = False
        dgvRoster.RowTemplate.Height = 25
        dgvRoster.Size = New Size(1096, 275)
        dgvRoster.TabIndex = 0
        dgvRoster.Theme = Guna.UI2.WinForms.Enums.DataGridViewPresetThemes.Dark
        dgvRoster.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(CByte(44), CByte(48), CByte(52))
        ...
        dgvRoster.ThemeStyle.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        dgvRoster.ThemeStyle.RowsStyle.SelectionForeColor = Color.White
        ' 
        ' txtFName
        ' 
        ...
        txtFName.CustomizableEdges = CustomizableEdges27
        ...
        txtFName.ShadowDecoration.CustomizableEdges = CustomizableEdges28
        ...
        dtpDOB.Name = "dtpDOB"
        dtpDOB.ShadowDecoration.CustomizableEdges = CustomizableEdges24
        ...
        dtpDOE.Checked = True
        dtpDOE.CustomizableEdges = CustomizableEdges21
        ...
        dtpDOE.Name = "dtpDOE"
        dtpDOE.ShadowDecoration.CustomizableEdges = CustomizableEdges22
        ...
        Label4.ForeColor = Color.FromArgb(CByte(102), CByte(6), CByte(8))
        ...
        cmbSearch.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        ...
        Label11.Font = New Font("Segoe UI", 8.25F, FontStyle.Bold Or FontStyle.Underline, GraphicsUnit.Point)
        Label11.Location = New Point(433, 25)
        ...
        txtCount.CustomizableEdges = CustomizableEdges15
        ...
        txtCount.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        txtCount.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        ...
        GroupBox2.Controls.Add(Guna2Button6)
        ...
        GroupBox2.Location = New Point(550, 134)
        ...
        btnAdd.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        btnUpdate.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        btnDelete.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        btnReset.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        btnPrint.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        Guna2Button6.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ...
        btnReload.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        btnReload.Font = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        ...
        ' Guna2GroupBox1
        ' 
        Guna2GroupBox1.BackColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        Guna2GroupBox1.BorderColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        Guna2GroupBox1.BorderThickness = 2
        Guna2GroupBox1.Controls.Add(Guna2HtmlLabel13)
        Guna2GroupBox1.Controls.Add(Guna2HtmlLabel12)
        Guna2GroupBox1.Controls.Add(tglPresent)
        Guna2GroupBox1.Controls.Add(txtPRHCode)
        ...
        ' cbLevel
        ' 
        cbLevel.AutoSize = True
        cbLevel.BackgroundImageLayout = ImageLayout.Stretch
        cbLevel.CheckedState.BorderColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        cbLevel.CheckedState.BorderRadius = 0
        cbLevel.CheckedState.BorderThickness = 0
        cbLevel.CheckedState.FillColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        cbLevel.CheckMarkColor = Color.Black
        cbLevel.Font = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        cbLevel.ForeColor = Color.White
        cbLevel.Location = New Point(78, 62)
        cbLevel.Name = "cbLevel"
        cbLevel.Size = New Size(87, 29)
        cbLevel.TabIndex = 0
        cbLevel.Text = "Level I"
        cbLevel.UncheckedState.BorderColor = Color.FromArgb(CByte(125), CByte(137), CByte(149))
        cbLevel.UncheckedState.BorderRadius = 0
        cbLevel.UncheckedState.BorderThickness = 0
        cbLevel.UncheckedState.FillColor = Color.FromArgb(CByte(125), CByte(137), CByte(149))
        ' 
        ' cmbInfraction
        ' 
        ...
        cmbInfraction.CustomizableEdges = CustomizableEdges63
        ...
        cmbInfraction.Location = New Point(178, 58)
        cmbInfraction.Name = "cmbInfraction"
        cmbInfraction.ShadowDecoration.CustomizableEdges = CustomizableEdges64
        ...
        txtPRHCode.CustomizableEdges = CustomizableEdges61
        ...
        txtPRHCode.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPRHCode.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPRHCode.FillColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        txtPRHCode.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPRHCode.Font = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        txtPRHCode.ForeColor = Color.White
        txtPRHCode.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPRHCode.Location = New Point(843, 55)
        txtPRHCode.Margin = New Padding(4, 5, 4, 5)
        txtPRHCode.Name = "txtPRHCode"
        txtPRHCode.PasswordChar = ChrW(0)
        txtPRHCode.PlaceholderText = ""
        txtPRHCode.ReadOnly = True
        txtPRHCode.SelectedText = ""
        txtPRHCode.ShadowDecoration.CustomizableEdges = CustomizableEdges62
        ...
        tglPresent.CustomizableEdges = CustomizableEdges59
        tglPresent.Location = New Point(491, 102)
        tglPresent.Name = "tglPresent"
        tglPresent.ShadowDecoration.CustomizableEdges = CustomizableEdges60
        ...
        Guna2GroupBox2.Controls.Add(btnStatement)
        Guna2GroupBox2.Controls.Add(btnOpenDirectory)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel10)
        Guna2GroupBox2.Controls.Add(txtLocation)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel6)
        Guna2GroupBox2.Controls.Add(btnCreateDocs)
        Guna2GroupBox2.Controls.Add(btnResetForm)
        Guna2GroupBox2.Controls.Add(txtDetails)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel9)
        Guna2GroupBox2.Controls.Add(dtpDOI)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel7)
        Guna2GroupBox2.Controls.Add(dtpDOE2)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel8)
        Guna2GroupBox2.Controls.Add(dtpDOB2)
        Guna2GroupBox2.Controls.Add(lblAppealDate)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel5)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel4)
        Guna2GroupBox2.Controls.Add(dtpFFBDate)
        Guna2GroupBox2.Controls.Add(Guna2HtmlLabel3)
        Guna2GroupBox2.Controls.Add(dtpNotification)
        ...
        cmbStudentName.CustomizableEdges = CustomizableEdges55
        ...
        cmbStudentName.ShadowDecoration.CustomizableEdges = CustomizableEdges56
        cmbStudentName.Size = New Size(372, 36)
        cmbStudentName.TabIndex = 0
        ' 
        ' txtStudentID
        ' 
        txtStudentID.CustomizableEdges = CustomizableEdges53
        ...
        txtStudentID.Location = New Point(268, 108)
        ...
        txtStudentID.ShadowDecoration.CustomizableEdges = CustomizableEdges54
        ...
        dtpNotification.Format = DateTimePickerFormat.Short
        dtpNotification.Location = New Point(268, 147)
        dtpNotification.Name = "dtpNotification"
        dtpNotification.Size = New Size(372, 29)
        dtpNotification.TabIndex = 4
        ' 
        ' dtpFFBDate
        ' 
        dtpFFBDate.CalendarFont = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        dtpFFBDate.Format = DateTimePickerFormat.Short
        dtpFFBDate.Location = New Point(268, 179)
        dtpFFBDate.Name = "dtpFFBDate"
        dtpFFBDate.Size = New Size(372, 29)
        dtpFFBDate.TabIndex = 6
        ' 
        ' dtpDOB2
        ' 
        dtpDOB2.CalendarFont = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        dtpDOB2.Enabled = False
        dtpDOB2.Format = DateTimePickerFormat.Short
        dtpDOB2.Location = New Point(268, 211)
        dtpDOB2.Name = "dtpDOB2"
        dtpDOB2.Size = New Size(372, 29)
        dtpDOB2.TabIndex = 10
        ' 
        ' dtpDOE2
        ' 
        dtpDOE2.CalendarFont = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        dtpDOE2.Enabled = False
        dtpDOE2.Format = DateTimePickerFormat.Short
        dtpDOE2.Location = New Point(268, 243)
        dtpDOE2.Name = "dtpDOE2"
        dtpDOE2.Size = New Size(372, 29)
        dtpDOE2.TabIndex = 12
        ' 
        ' dtpDOI
        ' 
        dtpDOI.CalendarFont = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        dtpDOI.Format = DateTimePickerFormat.Short
        dtpDOI.Location = New Point(268, 274)
        dtpDOI.Name = "dtpDOI"
        dtpDOI.Size = New Size(372, 29)
        dtpDOI.TabIndex = 14
        ' 
        ' txtDetails
        ' 
        txtDetails.CustomizableEdges = CustomizableEdges51
        ...
        txtDetails.Location = New Point(268, 310)
        txtDetails.Margin = New Padding(4, 4, 4, 4)
        txtDetails.Multiline = True
        txtDetails.Name = "txtDetails"
        txtDetails.PasswordChar = ChrW(0)
        txtDetails.PlaceholderText = ""
        txtDetails.SelectedText = ""
        txtDetails.ShadowDecoration.CustomizableEdges = CustomizableEdges52
        txtDetails.Size = New Size(372, 160)
        txtDetails.TabIndex = 16
        ' 
        ' btnResetForm
        ' 
        btnResetForm.CustomizableEdges = CustomizableEdges49
        ...
        btnResetForm.FillColor = Color.OldLace
        ...
        btnResetForm.ShadowDecoration.CustomizableEdges = CustomizableEdges50
        ...
        btnCreateDocs.CustomizableEdges = CustomizableEdges47
        ...
        btnCreateDocs.FillColor = Color.Gainsboro
        ...
        btnCreateDocs.ShadowDecoration.CustomizableEdges = CustomizableEdges48
        btnCreateDocs.Size = New Size(143, 109)
        btnCreateDocs.TabIndex = 18
        btnCreateDocs.Text = "Generate Documents"' 
        ' txtLocation
        ' 
        txtLocation.CustomizableEdges = CustomizableEdges45
        ...
        txtLocation.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtLocation.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtLocation.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtLocation.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point)
        txtLocation.ForeColor = Color.Black
        txtLocation.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtLocation.Location = New Point(268, 479)
        ...
        txtLocation.ShadowDecoration.CustomizableEdges = CustomizableEdges46
        txtLocation.Size = New Size(372, 36)
        txtLocation.TabIndex = 20
        ' 
        ' btnOpenDirectory
        ' 
        btnOpenDirectory.CustomizableEdges = CustomizableEdges43
        ...
        btnOpenDirectory.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnOpenDirectory.FillColor = Color.OldLace
        btnOpenDirectory.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point)
        btnOpenDirectory.ForeColor = Color.Black
        btnOpenDirectory.Location = New Point(736, 294)
        btnOpenDirectory.Name = "btnOpenDirectory"
        btnOpenDirectory.ShadowDecoration.CustomizableEdges = CustomizableEdges44
        btnOpenDirectory.Size = New Size(143, 45)
        btnOpenDirectory.TabIndex = 22
        btnOpenDirectory.Text = "File Directory"' 
        ' btnStatement
        ' 
        btnStatement.CustomizableEdges = CustomizableEdges41
        ...
        btnStatement.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnStatement.FillColor = Color.OldLace
        btnStatement.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point)
        btnStatement.ForeColor = Color.Black
        btnStatement.Location = New Point(736, 236)
        btnStatement.Name = "btnStatement"
        btnStatement.ShadowDecoration.CustomizableEdges = CustomizableEdges42
        ...
        TabPage1.Controls.Add(Guna2HtmlLabel11)
        ...
        TabPage1.Controls.Add(btnUpdateDB)
        ...
        Guna2Separator1.Location = New Point(236, 45)
        ...
        Guna2Separator2.Location = New Point(265, 61)
        ...
        Guna2Separator3.Location = New Point(296, 77)
        ...
        Guna2Separator6.Location = New Point(657, 45)
        ...
        Guna2Separator5.Location = New Point(658, 61)
        ...
        Guna2Separator4.Location = New Point(658, 77)
        ...
        Guna2Button8.CustomizableEdges = CustomizableEdges73
        ...
        Guna2Button8.ShadowDecoration.CustomizableEdges = CustomizableEdges74
        ...
        btnUpdateDB.CustomizableEdges = CustomizableEdges71
        ...
        btnUpdateDB.ShadowDecoration.CustomizableEdges = CustomizableEdges72
        ...
        btnSettings.ShadowDecoration.CustomizableEdges = CustomizableEdges68
        ...
        Guna2CircleButton1.ShadowDecoration.CustomizableEdges = CustomizableEdges67
        ...
        tc1.TabIndex = 0
        tc1.TabMenuBackColor = Color.FromArgb(CByte(88), CByte(0), CByte(5))
        ' 
        ' Guna2HtmlLabel12
        ' 
        ...
        Guna2HtmlLabel1.Location = New Point(189, 76)
        ...
        Guna2HtmlLabel2.Location = New Point(169, 115)
        ...
        Guna2HtmlLabel3.Location = New Point(122, 150)
        ...
        Guna2HtmlLabel4.Location = New Point(183, 182)
        ...
        Guna2HtmlLabel5.Location = New Point(736, 70)
        ...
        lblAppealDate.Location = New Point(744, 108)
        ...
        Guna2HtmlLabel8.Location = New Point(154, 214)
        ...
        Guna2HtmlLabel7.Location = New Point(152, 246)
        ...
        Guna2HtmlLabel9.Location = New Point(129, 277)
        ...
        Guna2HtmlLabel6.Location = New Point(134, 310)
        ...
        Guna2HtmlLabel10.Location = New Point(136, 486)
        ...
        Guna2HtmlLabel11.Enabled = False
        Guna2HtmlLabel11.ForeColor = SystemColors.ControlLightLight
        Guna2HtmlLabel11.Location = New Point(1045, 714)
        ...
        Text = "  EZ Fact Finding Board Document Generator"
    ...
    Friend WithEvents cbPresent As Guna.UI2.WinForms.Guna2RadioButton
    ...
    Friend WithEvents cmbSearch As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents Label4 As Label
    Friend WithEvents dtpDOE As Guna.UI2.WinForms.Guna2DateTimePicker
    ...
    Friend WithEvents cmbTrade As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cmbSize As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cmbIncentive As Guna.UI2.WinForms.Guna2ComboBox
    ...
    Friend WithEvents btnCreateDocs As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnResetForm As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents dtpDOE2 As DateTimePicker
    Friend WithEvents Guna2HtmlLabel8 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents dtpDOB2 As DateTimePicker
    Friend WithEvents lblAppealDate As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Guna2HtmlLabel5 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Guna2HtmlLabel4 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents dtpFFBDate As DateTimePicker
    Friend WithEvents Guna2HtmlLabel3 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents dtpNotification As DateTimePicker
    Friend WithEvents Guna2HtmlLabel2 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Guna2HtmlLabel1 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents txtStudentID As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents cmbStudentName As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents Guna2GroupBox1 As Guna.UI2.WinForms.Guna2GroupBox
    Friend WithEvents Guna2HtmlLabel13 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Guna2HtmlLabel12 As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents tglPresent As Guna.UI2.WinForms.Guna2ToggleSwitch
    Friend WithEvents txtPRHCode As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents cmbInfraction As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cbLevel As Guna.UI2.WinForms.Guna2CheckBox
    ...
    Friend WithEvents btnUpdateDB As Guna.UI2.WinForms.Guna2Button
